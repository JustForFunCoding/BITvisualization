...
Interface of 2D PU RQ BIT:
    - constructor (BitPuRq2d)
        ...
        - creates new instance of 2D PU RQ BIT of the given size,
            which is able to solve operations point update and range query
        - for example: bit2d = BitPuRq2d(8)
    - point update (updatep)
        - takes three integers: row, col and val
        - returns nothing, but 2D PU RQ BIT, on which is updatep called
