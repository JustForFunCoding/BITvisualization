...
Interface of 1D PU RQ BIT:
    - constructor (BitPuRq)
        ...
        - returns new instance of 1D PU RQ BIT of the given size initialized with 0s
    ...
    - syntactic sugar for advanced constructor (init)
        ...
        - returns new instance of 1D PU RQ BIT of the size as the given array initialized with numbers of array
    ...
    - point update (updatep)
        ...
        - returns nothing, but 1D PU RQ, on which is called updatep is modified appropriately
